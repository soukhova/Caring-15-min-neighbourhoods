...
<!-- Based on the SOM classification methodology discussed and the 15 variables represented in @fig-Fig4 and @fig-Fig5, 7 superclusters are identified. As diagnostics for the selection of the number of superclusters, the dissimilarity-index-based dendrogram with the proportion of parcels represented in each supercluster alongside the variance explained plot is visualised in @fig-Fig6. -->
<!-- ```{r plot-figure6, out.width=800, out.height=800} -->
<!-- #| label: fig-Fig6 -->
<!-- #| fig-cap: "The 7 resulting superclusters from the SOM the 10 by 10 grid output represented in a dendrogram (left) and the variance unexplained (right)." -->
<!-- #|  -->
<!-- knitr::include_graphics(glue::glue(here::here(), "/figures/all_access_sc_plot_small.png"))  -->
<!-- ``` -->

<!-- To characterise the superclusters, a table providing summary statistics of each supercluster is detailed in @tbl-tbl2: -->
<!-- ```{r creating-table2} -->
