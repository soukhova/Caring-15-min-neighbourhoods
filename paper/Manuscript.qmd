...
The "15-Minute City" has been adopted by leaders as a way to promote human-scaled cities. As defined in @moreno_introducing_2021, the 15-Minute City is a urban planning model based in "chrono-urbanism", a theory that emphasizes the positive impact on quality of urban life when urban space becomes multi-rythmic [related to chronotopy @mulicekUrbanRhythmsChronotopic2015]. Multi-rhythmic urban space in opposition to industrial Fordism and single-use zoning [@mulicekUrbanRhythmsChronotopic2015; @morenoVilleQuartHeure2016]; the segregation of urban time and space for individual uses and mobility. The 15-Minute City is one that accommodates the ability to reach essential destinations such as shops, work, and healthcare within a walkable radius. It would allow individuals to reclaim time spent on car mobility and give way to sustainable modes; prompting urban spaces that are responsive to human needs and environmental sensibilities [@Allam2022]. The 15-Minute City generated much interest in planning practice and public discourse, especially after Paris mayor Anne Hidalgo proposed a 15-minute city plan in her 2020 re-election campaign. Though the term 15-Minute City is relatively new, the core of the concept is not.

Literature has drawn parallels from the 15-Minute City to Perry's debated Neighbourhood Unit Concept (NUC) from the 1930s [@kissfazekasCircleParadigms15minute2022]; a 'socio-spatial' normative scheme widely adopted by government agencies (and the real-estate community) in the Western world after the Second World War [@talenSocialSciencePlanned2017; @solow1969concept]. Pairing well with the objectives of planning agencies at the time, Perry's NUC would allow for efficient mass-building of cellular units that prioritized the perceived functional needs of women and children: each unit providing proximate access to an elementary school and sufficent supporting community facilities, shopping, parks and housing [@talenSocialSciencePlanned2017; @brodyNeighbourhoodUnitConcept2013]. The NUC primarily prioritized local service provision, though Perry had confidence in good design's contribution to 'neighbourhood spirit' [@hall2014cities]. From the NUC's conception until the end of the 1960s, planner's attempts to prescribe social meaning to the neighbourhood's physical form had been criticized to near extinction [@talenSocialSciencePlanned2017]. By social scientists, the overestimation on the impact of built environment on social life was critiqued. By other planners, the inability to agree on the specificity of the neighbourhood (i.e., population sized, and the type, quality, and quantity of amenity) as well as how neighbourhood units are connected to other neighbourhoods and the rest of the region. <!-- failing to combine work, home and cultre was a dilbirate outcome of state-sponsored capitalism X. As stated in [@talenSocialSciencePlanned2017],-->  In response to these criticisms, neighbourhood planning proponents have redefined deterministic terminology: prescribed physical forms is 'enabling' rather than engendering, and the provision of social contact 'opportunities' instead of determined social behaviour. The redefined bottom-up concept to community and neighbourhood planning has been adopted by New Urbanist from which the 15-Minute City stems. The 15-Minute City is created through bottom-up proximity-based processes of community planning [@kissfazekasCircleParadigms15minute2022].
...
However, critiques of social scientists and planners from decades past still persist. Can physical form be planned to enable an improved quality of life? This line of reasoning has occupied urban planning research in recent years: what are the impacts of built environment on residence's outcomes. A popular tool to analyse this relationship has often been accessibility analysis: proximity to X amenity results in X outcomes for a neighboourhood. Accessibility is a way of quantifying the ease of opportunity interaction from some point in space, this indicator is becoming increasingly important for planners in the pursuit of just and sustainable city planning [@vale2023accessibility; @handyAccessibilityIdeaWhose2020]. As a amenity-provision concept of neighbourhood planning that seeks to enable an improvement on urban quality of life, the 15-Minute City lends well to analysis using accessibility tools. 
...
Caring activities meet the physical, psychological, and emotional needs of others, and are one of the most essential and fundamental activities in society [@ilo_care_2018]. Yet, they are the most unequal, undervalued, and even devalued activities worldwide. Traditionally, caring activities have been borne on women’s shoulders [@haydenGrandDomesticRevolution1982; @hochschild_second_2012]. According to @ilo_care_2018, women and girls perform more than three-quarters of the total amount of unpaid care, a gender gap that varies geographically [@RN5]. 
...
`r word_comment("TO ADD: some good feminist 15 minute cities. It's novel but movements exists in the Canadian context i.e., https://x.com/brenttoderian/status/1800371515877384527?s=48&t=QI0WSvV_FDb82ZGeLdJ9lQ. Also discuss Barcelona and Bogota (care blocks) non academic sources: https://oecd-opsi.org/innovations/bogota-care-blocks/ AND https://www.npr.org/sections/goatsandsoda/2023/10/16/1205218707/how-bogota-cares-for-its-family-caregivers-from-dance-classes-to-job-training )", " ")`
...
Taken together, city planning is moving to a people-centered approach focusing on accessibility to basic needs. However, chrono-urbanism stems from conventional methods that overlooks mobility of care perspectives. To counter this, this paper presents a 15-minute cities methodological approach to assess mobility of care. We develop this approach using a mid-size typical Canadian city and a novel care destination dataset as case study. The objectives of the paper are as follows:
...
Decision trees area a supervised learning technique, which can use the results of the clustering algorithm as labels, and the input variables as features.

# Results

Accessibility results per care category are presented in @fig-Fig4. The concentration of opportunities for all category types is concentrated in Hamilton Central - with the highest concentration being in the lower city and pockets of the high concentration on the mountain `r word_comment("(TO ADD: The escarpment line)", " ")`. Grocery-centric opportunities are most concentrated, followed by dependent-centric and health-centric. Errand-centric is the most sprawled. 
...
The diversity of care destinations accessible is presented in @fig-Fig5. Here, it appears that neighbourhoods with a diversity of care destinations accessible are concentrated in the downtown core. Of note, some suburban areas also exhibit a high diversity of care access, these areas _have the potential_ to be retrofitted/ designed for access care (ADD MORE).
