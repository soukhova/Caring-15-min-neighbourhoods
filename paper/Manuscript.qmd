...
Caring is one of the most fundamental activities in societies, since it consists of numerous activities that allow them to thrive. Caring activities are those that strive to meet the physical, psychological, and emotional needs of others [@ilo_care_2018]. Yet, it is one of the most unequal, undervalued, and even devalued activities worldwide. Traditionally, caring activities have been borne on women’s shoulders. Though women today attain higher educational levels and tend to work out of home more than ever before, the 'Second Shift' remains mostly women’s work  in all industrial societies [@hayden_grand_2000; @hochschild_second_2012]. According to @ilo_care_2018, women and girls perform more than three-quarters of the total amount of unpaid care, a gender gap that varies geographically [@RN5]. In Canada, adult women complete 1.9 hours, on average, more of unpaid care than men every day [@RN4].
...
`r word_comment("Good 15 minute city example, but what about feminist 15 minute cities? It's novel but movements exists such as https://x.com/brenttoderian/status/1800371515877384527?s=48&t=QI0WSvV_FDb82ZGeLdJ9lQ", " ")`
...
There seems to be a spatial mismatch where dwelling availability and affordability play an important role? (NOTE: LMD has have questions about the results) Are there social housing programs for lower income households?
