...
access_15_DA$V_iscDA |> sum(na.rm=T)
...
tmap_save(all_cats_bivariate_entropy_copp_plot, 
          file= file.path(here("figures/all_cats_bivariate_entropy_copp_plot.tiff")),
          dpi=600)
```
...
tmap_save(care_categories_plot, 
          file= file.path(here("figures/care_categories_plot.tiff")),
          dpi=600)
```
```{r}
parcels_DA_plot <- 
